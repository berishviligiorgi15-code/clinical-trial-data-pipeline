...
Dataset
The original data/clin_trials.csv file is not included in this repository because it exceeds GitHub file size limits.
To run the full pipeline locally, place the dataset at:
data/clin_trials.csv
You can also use a smaller sample dataset for testing and demonstration.
